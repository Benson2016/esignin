	...
	$.fn.extend({
		...
		html5Validate: function(callback, options) {
			...
			$(this).bind("submit", function() {
				...
				/* chvin 2014.11.20 update start 修正了无法提交的问题*/
				if ($.html5Validate.isAllpass(elements, params) && params.validate()) {
					if($.isFunction(callback)){//如果设了callback必须返回true
						if(callback.call(this) !== true)
							return false;
					}
					return true;
				}
				/* chvin 2014.11.20 update end*/
