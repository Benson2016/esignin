...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="${root}/resources/css/pages/tasks.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed">
        ...
        <div class="header navbar navbar-inverse navbar-fixed-top">
            ...
            <div class="header-inner">
                ...
                <a class="navbar-brand" href="javascript:;">
                    <img src="${root}/resources/img/logo.png" alt="logo" class="img-responsive" />
                </a>
                <!-- END LOGO -->
                <!-- BEGIN RESPONSIVE MENU TOGGLER -->
                <a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <img
                    src="${root}/resources/img/menu-toggler.png" alt="" />
                </a>
        ...
        <script src="${root}/resources/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.js" type="text/javascript"></script>
        <script src="${root}/resources/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="${root}/resources/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
        ...
        <script src="${root}/resources/plugins/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
        ...
        <script src="${root}/commons/js/index.js" type="text/javascript"></script>

        <!-- <script data-main="${root}/commons/js/main" src="${root}/commons/lib/requirejs/require.js"></script> -->
    </body>
</html>