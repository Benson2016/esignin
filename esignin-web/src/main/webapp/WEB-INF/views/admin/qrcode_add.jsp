...
<body>
  <div class="mainContent">
    <form name="addForm" action="${root}/code/addQrCode.bs" >
      ...
      <input type="text" name="effectiveTimeStart" id="dStartTime" class="g-input l w-180" value=""  style="margin-right:10px" >
      <div class="clear"></div>

      <label class="g-label l">结束时间 &nbsp;</label>
      <input type="text" name="effectiveTimeEnd" id="dEndTime" class="g-input l w-180" value=""  style="margin-right:10px" >
      <div class="clear"></div>
