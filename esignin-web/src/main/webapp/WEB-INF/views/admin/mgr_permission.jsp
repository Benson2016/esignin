...
<div class="screen">
    ...
    <div class="contentBox">
        ...
        <div class="configureBox"  >
            <!-- 查询与导出 -->
            <form id="searchForm" action="${root}/admin/exportPermDataToExcel.bs" method="post">
            ...
            <div class="tableTopBtn">
                <shiro:hasPermission name="addPerm">
                    <a class="addBtn g-searchBtn" href="javascript:void(0)">添 加</a>&nbsp;&nbsp;
                </shiro:hasPermission>
                <shiro:hasPermission name="deletePermission">
...
<script>
    ...
    $(function () {
        ...
        $('.tableTopBtn').delegate('.addBtn', 'click', function(){
            showFormDialog("${root}/page/toPermAdd.bs", "addForm", "添加权限", 610, 560, {yes: "保 存", yes_before_close:checkAddForm, yes_after_close: null});
        });
    ...
    function openEdit(id) {
        showFormDialog("${root}/perm/toPermEdit.bs?pid="+id, "editForm", "编辑权限信息", 610, 560, {yes: "保 存", yes_before_close:checkFormForEdit, yes_after_close: null});
    }
